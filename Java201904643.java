// Assignment 1//
/* Manpreet Kaur Sekhon Student ID 201904643*/
// IN2203-G2, Sat 8am 2021W //
package javacode;
import java.util.*;
import java.lang.Math;


public class Java201904643 {
...
class Casino{
    ...
    String userAnswer;
        ...
        public void OrganizeNewGame(){
            System.out.print("Welcome to the Grand Casino: Would you like to play a game at our beautiful casino? (yes/no)");
...
{System.out.println("Good Bye,Dear Player!!");}
}
}
class Game{
    Random r= new Random();
